...
//    private final static int poolMaxSize = (int) (numberOfCores / (1 - blockingCoefficient));
	 ...
	 * 这个值和理论完全相符，因为 32 位 linux 下的进程用户空间是 3G 的大小，也就是 3072M，用 3072M 除以 8M 得 384
	 * 为了突破内存的限制，可以有两种方法
	 ...
	 */
    private final static int poolMaxSize = (int) (Runtime.getRuntime().maxMemory() / 1024 /1024 / 12);
